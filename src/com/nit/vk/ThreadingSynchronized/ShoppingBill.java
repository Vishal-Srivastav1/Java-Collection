...
{  
    public static void main(String args[])   
        {  
            ...
            System.out.println("\t\t\t\t\t "+"  "+"Vishal Mart Grocery Shop");  
            System.out.println("\t\t\t\t\t3/98 kasia (KUSHINAGAR)");  
            System.out.println("\t\t\t\t\t"  +"    " +"Opposite Metro Walk");  
            System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 9305397531");  
            ...
            System.out.println("Date: "+formatter.format(date)+"  "+days[calendar.get(Calendar.DAY_OF_WEEK) - 1]+"\t\t\t\t\t\t (+91) 9305397531");  
